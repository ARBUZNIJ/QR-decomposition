...
//		for (i = 0; i < n; i++)
//		{
//			w[i * block_size] = (norm) * v[i];
//		}
//
//		for (i = 1; i < block_size; i++) //ïî ñòîëáöàì ðåçóëüòàòà â w
//		{
//			norm = 0.0;
//			for (k = 0; k < n; k++)
//			{
...
//					{
//
//						w[j * block_size + i] += (w[j * block_size + m] * v[m * n + k] + (j == k ? 1 : 0)) * v[i * n + k] * (norm);
//					}
//				}
//			}
//		}
...
//			for (k = 0; k < n; k++) //ïî ñòðîêàì Y == v
//			{
//				for (m = 0; m < block_size; m++) //ïî ñòîëáöàì W
//				{
